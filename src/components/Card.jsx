    ...
    <>
      <div className=" relative h-auto grid-flow-row w-auto flex flex-col">
        <div className="relative opacity-100 z-20 grid items-center text-center justify-items-center ">
          ...
          <h1 className="mt-3  text-6xl lg:text-5xl md:text-4xl sm:text-3xl xsm:text-2xl font-semibold filter drop-shadow-sm text-black-100">
            Powerd By Technology
          </h1>
          <h6 className="text-sm lg:text-md md:text-sm sm:text-xsm  filter drop-shadow-sm text-center text-gray-800 mt-5 w-5/12 h-2 opacity-50">
        ...
        <div className="flex res min  mt-12  p-12 ">
          <div className="relative  rounded-t-lg z-20 h-48 mt-28  drop-shadow-2xl border ">
            ...
            <div className="p-5">
              <h1 className="font-semibold mt-0 m-auto">Superviser</h1>
